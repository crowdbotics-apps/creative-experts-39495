"""
Django settings for creative_experts_39495 project.
...
ROOT_URLCONF = 'creative_experts_39495.urls'
...
WSGI_APPLICATION = 'creative_experts_39495.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "creative_experts_39495 API",
    "DESCRIPTION": "API documentation for creative_experts_39495 App",
    "VERSION": "v1",
}
